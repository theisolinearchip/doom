...
{ 
    ...
    // TODO: fix the version stuff
    if ( demoversion != VERSION && demoversion != 109)
    {
      fprintf( stderr, "Demo is from a different game version! (allowed: %d, %d; current WAD file version: %d)\n", VERSION, 109, demoversion);
      gameaction = ga_nothing;
      return;
    }
